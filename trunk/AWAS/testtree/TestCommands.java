...
public class TestCommands {
    ...
    public static final String EXPAND_PATHS_COMMAND = "EXPAND_PATHS_COMMAND";
    public static final String COLLAPSE_PATHS_COMMAND = "EXPAND_PATHS_COMMAND";

    public static final String ADD_NODE_COMMAND = "ADD_NODE_COMMAND";
    public static final String DELETE_NODE_COMMAND = "DELETE_NODE_COMMAND";
    public static final String CLEAR_TREE_COMMAND = "CLEAR_TREE_COMMAND";
