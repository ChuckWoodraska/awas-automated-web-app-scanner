...
public class SeparateTableCellEditor extends JDialog implements ActionListener {
    ...
    public SeparateTableCellEditor(JTextArea textArea) {
    	super(new JFrame(), "Edit Table Cell", true);
